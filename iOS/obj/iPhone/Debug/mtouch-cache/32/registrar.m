...
static BOOL native_to_managed_trampoline_10 (id self, SEL _cmd, MonoMethod **managed_method_ptr, NSInteger p0, const char *r0, const char *r1, const char *r2)
{
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "SplashVideo.iOS.AppDelegate, SplashVideo.iOS", "get_Window");
	}

	-(void) setWindow:(UIWindow *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS", "SplashVideo.iOS.AppDelegate, SplashVideo.iOS", "set_Window");
	}

	-(BOOL) application:(UIApplication *)p0 didFinishLaunchingWithOptions:(NSDictionary *)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "SplashVideo.iOS.AppDelegate, SplashVideo.iOS", "FinishedLaunching");
	}

	-(void) applicationWillResignActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "SplashVideo.iOS.AppDelegate, SplashVideo.iOS", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "SplashVideo.iOS.AppDelegate, SplashVideo.iOS", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "SplashVideo.iOS.AppDelegate, SplashVideo.iOS", "WillEnterForeground");
	}

	-(void) applicationDidBecomeActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "SplashVideo.iOS.AppDelegate, SplashVideo.iOS", "OnActivated");
	}

	-(void) applicationWillTerminate:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "SplashVideo.iOS.AppDelegate, SplashVideo.iOS", "WillTerminate");
	}
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_7 (self, _cmd, &managed_method, "SplashVideo.iOS.AppDelegate, SplashVideo.iOS", ".ctor", &call_super);
		if (call_super && rv) {
...
@implementation ViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, "SplashVideo.iOS.ViewController, SplashVideo.iOS", "get_Button");
	}

	-(void) setButton:(UIButton *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "SplashVideo.iOS.ViewController, SplashVideo.iOS", "set_Button");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "SplashVideo.iOS.ViewController, SplashVideo.iOS", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "SplashVideo.iOS.ViewController, SplashVideo.iOS", "DidReceiveMemoryWarning");
	}
...
@implementation AVPlayerViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "SplashVideo.iOS.AVPlayerViewController, SplashVideo.iOS", "ViewDidLoad");
	}

	-(void) viewDidUnload
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "SplashVideo.iOS.AVPlayerViewController, SplashVideo.iOS", "ViewDidUnload");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "SplashVideo.iOS.AVPlayerViewController, SplashVideo.iOS", "DidReceiveMemoryWarning");
	}

	-(BOOL) shouldAutorotateToInterfaceOrientation:(NSInteger)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, "UIKit.UIInterfaceOrientation, Xamarin.iOS", "SplashVideo.iOS.AVPlayerViewController, SplashVideo.iOS", "ShouldAutorotateToInterfaceOrientation");
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_7 (self, _cmd, &managed_method, "SplashVideo.iOS.AVPlayerViewController, SplashVideo.iOS", ".ctor", &call_super);
		if (call_super && rv) {
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AVAsset", "AVFoundation.AVAsset, Xamarin.iOS", NULL },
		...
		{"AppDelegate", "SplashVideo.iOS.AppDelegate, SplashVideo.iOS", NULL },
		{"ViewController", "SplashVideo.iOS.ViewController, SplashVideo.iOS", NULL },
		{"AVPlayerViewController", "SplashVideo.iOS.AVPlayerViewController, SplashVideo.iOS", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [3].handle = objc_getClass ("CALayer");
	__xamarin_class_map [4].handle = objc_getClass ("AVPlayerLayer");
	...
	__xamarin_class_map [7].handle = objc_getClass ("AVPlayer");
	__xamarin_class_map [8].handle = objc_getClass ("UIView");
	__xamarin_class_map [9].handle = objc_getClass ("AVAsset");
	...
	__xamarin_class_map [31].handle = objc_getClass ("AVPlayerItem");
	...
	__xamarin_class_map [40].handle = [AVPlayerViewController class];
